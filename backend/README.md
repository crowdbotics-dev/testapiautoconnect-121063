...
## Project Structure
    ...
    ├── testapiautoconnect_121063  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_121063`
...
2. Clone this repo and `cd testapiautoconnect_121063`
